...
export default class BuyTurntable implements View {
    ...
    constructor() {
        ...
        Layout.current.content.append(this.container = el(".buy-turntable-view",
            ...
            el("p.warning",
                "* 배터리 수명이 다 된 턴테이블은 배터리를 충전해야합니다. 배터리 충전 가격은 턴테이블의 가격의 1/5와 비례하며, 턴테이블의 가격과 같은 액수의 MIX로 배터리를 충전하면 턴테이블 수명의 5배의 수명이 더해집니다.",
                "\n",
                el("b", "충전에 사용된 믹스는 전량 소각되고, 턴테이블 분해시에 돌려받을 수 없습니다.", { style: { fontWeight: "bold" } }),
            ),
            el(".turntable-list",
