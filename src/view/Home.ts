      ...
      (this.container = el(
        ...
        el(
          ...
          el(
            ...
            "\n",
            el("a", `▶ ${msg("HOME_SECTION_2_LINK_3")}`, {
          ...
          el(
            ...
            el(
              ...
              el(
                ...
                { href: "https://klayswap.com/", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://www.codestates.com/", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://clonesneverdie.com/", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://www.casesbykate.xyz/", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://discord.gg/HTm6hZGGxN", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://nftz.co.in/", target: "_blank" }
              )
            ),
            el(
              "li",
              el(
                ...
                { href: "https://animals-punks.com/", target: "_blank" }
              )
            )
          )
        ),
        el(
          ...
          el(
            "p",
            `- ${msg("HOME_CONTACT_DISCORD")} : `,
            el("a", "https://discord.gg/gQ27tC9kmE", {
              href: "https://discord.gg/gQ27tC9kmE",
              target: "_blank",
            }),
            "\n",
            `- ${msg("HOME_CONTACT_TWITTER")} : `,
            el("a", "https://twitter.com/dogesoundclub", {
              href: "https://twitter.com/dogesoundclub",
              target: "_blank",
            }),
            "\n",
            `- ${msg("HOME_CONTACT_INSTAGRAM")} : @dogesoundclub\n`,
            `- ${msg("HOME_CONTACT_MEDIUM")} : `,
            el("a", "https://medium.com/dogesoundclub", {
              href: "https://medium.com/dogesoundclub",
              target: "_blank",
            }),
            "\n",
            `- ${msg("HOME_CONTACT_GITHUB")} : `,
            el("a", "https://github.com/dogesoundclub", {
              href: "https://github.com/dogesoundclub",
              target: "_blank",
            }),
            "\n",
            `- ${msg("HOME_CONTACT_YOUTUBE")} : `,
            el(
              "a",
              "https://www.youtube.com/channel/UCnt1jjJpL-YdHNcooykdY4w",
              {
    ...
    try {
      ...
      if (this.container.deleted !== true) {
        this.winner
          .empty()
          .appendText(
            `${msg("HOME_WINNER_TITLE").replace(
              /{round}/,
              String(winnerInfo.round + 1)
            )} `
          );
        this.winner.append(
          el("a", winnerInfo.winner, {
        ...
        this.dogesound
          .empty()
          .appendText(
            `${msg("HOME_WINNER_DESCRIPTION").replace(
              /{round}/,
              String(winnerInfo.round + 1)
