...
export default class Home implements View {
    ...
    constructor() {
        ...
        Layout.current.content.append(this.container = el(".home-view",
            ...
            el("section",
                el("h2", msg("HOME_SENTENCE_1_TITLE")),
                el("p", msg("HOME_SENTENCE_1")),
            ),
            el("section",
                el("header.mates",
                ...
                el("h2", msg("HOME_SENTENCE_2_TITLE")),
                el("p",
                    msg("HOME_SENTENCE_2_1"), "\n",
                    el("a", `▶ ${msg("HOME_SENTENCE_2_LINK_1")}`, { click: () => SkyRouter.go("/mates") }), "\n",
                    el("a", `▶ ${msg("HOME_SENTENCE_2_LINK_2")}`, { click: () => SkyRouter.go("/activities") }), "\n",
                    "\n",
                    msg("HOME_SENTENCE_2_2"), "\n",
                    el("a", `▶ ${msg("HOME_SENTENCE_2_LINK_3")}`, { href: "https://opensea.io/collection/dogesoundclub-mates" }), "\n",
                    msg("HOME_SENTENCE_2_3"),
                ),
            ),
            el("section",
                el("h2", msg("HOME_SENTENCE_3_TITLE")),
                el("p", msg("HOME_SENTENCE_3")),
                el("iframe.video", {
                    height: "486",
            ...
            el("section",
                el("h2", msg("HOME_SENTENCE_4_TITLE")),
                el(".team",
    ...
    private async loadWinner() {
        this.winner.appendText(`${msg("HOME_WINNER_TITLE").replace(/{round}/, String(1))} `);
        this.winner.append(el("a", "0x7c8E0D8E520e2BF9647572a1998afa7D1631f16e"));
    }

    private async loadDogeSound() {
        this.dogesound.appendText(`${msg("HOME_WINNER_DESCRIPTION").replace(/{round}/, String(1))} \nㅡ`);
    }
