...
class AnimalsPunksV2Contract extends Contract {

    constructor() {
        super(Config.contracts.AnimalsPunksV2, require("./AnimalsPunksV2ContractABI.json"));
    }
...
export default new AnimalsPunksV2Contract();
