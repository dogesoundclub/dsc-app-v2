...
interface DogeSoundClubMateInterface extends ethers.utils.Interface {
  functions: {
...
export class DogeSoundClubMate extends Contract {
  ...
  interface: DogeSoundClubMateInterface;
  ...
  callStatic: {
    ...
    massMint(lv: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    massMint(lv: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
