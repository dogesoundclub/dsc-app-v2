...
class KLITSContract extends Contract_1.default {
    constructor() {
        super(Config_1.default.contracts.KLITS, require("./KLITSContractABI.json"));
    }
...
exports.default = new KLITSContract();
//# sourceMappingURL=KLITSContract.js.map