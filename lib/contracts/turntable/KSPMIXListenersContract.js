...
class KSPMIXListenersContract extends Contract_1.default {
    constructor() {
        super(Config_1.default.contracts.KSPMIXListeners, require("./TurntableKIP7ListenersContractABI.json"));
    }
