    ...
    async load() {
        ...
        if (walletAddress !== undefined) {
            ...
            if (walletAddress === winner) {
                this.append((0, skynode_1.el)("p", (0, msg_js_1.default)("DOGESOUNDS_WINNER_MENT").replace(/{round}/, String(this.round))), (0, skynode_1.el)("a.nft-mint-button", (0, msg_js_1.default)("DOGESOUNDS_WINNER_NFT_MINT_BUTTON"), {
