...
class VoteForm extends skynode_1.DomNode {
    constructor(round) {
        ...
        })), this.mateList = new MateList_1.default(true), (0, skynode_1.el)("a.submit-button", (0, msg_js_1.default)("DOGESOUNDS_VOTE_SUBMIT"), {
            click: async () => {
...
//# sourceMappingURL=VoteForm%20copy.js.map