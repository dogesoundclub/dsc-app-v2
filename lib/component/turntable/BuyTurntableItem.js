...
class BuyTurntableItem extends skynode_1.DomNode {
    constructor(typeId) {
        ...
        this.append((0, skynode_1.el)("h4", turntable.name, { style: { color: turntable.color } }), (0, skynode_1.el)("img", { src: turntable.img }), (0, skynode_1.el)(".volume", `Volume: ${CommonUtil_1.default.numberWithCommas(turntable.volume)}`), (0, skynode_1.el)(".price", `Price: ${CommonUtil_1.default.numberWithCommas(turntable.price)} MIX`), (0, skynode_1.el)(".lifetime", `Lifetime: ${CommonUtil_1.default.numberWithCommas(turntable.lifetime)} Blocks`), (0, skynode_1.el)("a", "구매하기", {
            click: async () => {
    ...
    async loadAPR() {
        ...
        const batteryPrice = ethers_1.utils.parseEther(String(turntable.price)).div(2);
        const annualCost = turntablePrice.add(batteryPrice.mul(ethers_1.utils.parseEther((blocksPerYear / turntable.lifetime - 1).toFixed(18))).div(ethers_1.constants.WeiPerEther));
