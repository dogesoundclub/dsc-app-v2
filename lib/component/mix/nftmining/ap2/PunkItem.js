...
const imageUrl_json_1 = __importDefault(require("./imageUrl.json"));
class PunkItem extends skynode_1.DomNode {
    constructor(tab, id) {
        ...
        const info = imageUrl_json_1.default.data.V2_nfts.find((info) => {
            return info.image_url.indexOf(`/${id}.png`) !== -1;
        });
        this.append((0, skynode_1.el)(".content", (0, skynode_1.el)(".punk", { style: { backgroundImage: `url(${info?.image_url})` } }, (0, skynode_1.el)("span.id", `#${id}`)), (0, skynode_1.el)(".info", (0, skynode_1.el)("h5", "쌓인 MIX"), this.mixAmount = (0, skynode_1.el)(".amount", "Loading...")), (0, skynode_1.el)(".controller", (0, skynode_1.el)("a.claim-button", "받기", {
            click: async () => {
