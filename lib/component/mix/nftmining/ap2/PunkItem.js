...
class PunkItem extends skynode_1.DomNode {
    constructor(tab, id) {
        ...
        this.append((0, skynode_1.el)(".content", this.punk = (0, skynode_1.el)(".punk", (0, skynode_1.el)("span.id", `#${id}`)), (0, skynode_1.el)(".info", (0, skynode_1.el)("h5", "쌓인 MIX"), this.mixAmount = (0, skynode_1.el)(".amount", "Loading...")), (0, skynode_1.el)(".controller", (0, skynode_1.el)("a.claim-button", "받기", {
            click: async () => {
