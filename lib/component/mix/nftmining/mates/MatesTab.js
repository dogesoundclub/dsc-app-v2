...
class MatesTab extends skynode_1.DomNode {
                ...
                if (owner !== undefined) {
                    ...
                    if (balance.lt(fee)) {
                        ...
                        if ((await MixContract_1.default.allowance(owner, MatesPoolContract_1.default.address)).lt(fee)) {
                            await MixContract_1.default.approve(MatesPoolContract_1.default.address, fee);
                            setTimeout(async () => {
    ...
    changeMix(mix) {
        ...
        this.totalMixDisplay.empty().appendText(CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(this.totalMix)));
    }
}
