...
const Governance_1 = __importDefault(require("./view/activities/Governance"));
const Detail_1 = __importDefault(require("./view/activities/governance/Detail"));
const Propose_1 = __importDefault(require("./view/activities/governance/Propose"));
