...
const DogeSound_1 = __importDefault(require("./view/activities/DogeSound"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route("activity", Activities_1.default);
    skyrouter_1.SkyRouter.route("activity/dogesound", DogeSound_1.default);
