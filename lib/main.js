...
const CheckCaseHolder_1 = __importDefault(require("./view/CheckCaseHolder"));
const CheckEMateHolder_1 = __importDefault(require("./view/CheckEMateHolder"));
const CheckMateHolder_1 = __importDefault(require("./view/CheckMateHolder"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route("**", Layout_1.default, ["checkmateholder", "checkemateholder", "checkcaseholder"]);
    ...
    skyrouter_1.SkyRouter.route("checkmateholder", CheckMateHolder_1.default);
    skyrouter_1.SkyRouter.route("checkemateholder", CheckEMateHolder_1.default);
    skyrouter_1.SkyRouter.route("checkcaseholder", CheckCaseHolder_1.default);
