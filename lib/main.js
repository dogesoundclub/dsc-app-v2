...
const NFTMining_1 = __importDefault(require("./view/mix/NFTMining"));
const Turntables_1 = __importDefault(require("./view/mix/Turntables"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route("mix/mining", NFTMining_1.default);
    skyrouter_1.SkyRouter.route("mix/turntables", Turntables_1.default);
