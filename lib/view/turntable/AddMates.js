...
class AddMates {
    constructor(params) {
        ...
        }), (0, skynode_1.el)("p", "해당 턴테이블에 리스너로 등록할 메이트를 선택해주시기 바랍니다."), this.mateRewardInfo = (0, skynode_1.el)("p.mate-reward-info"), this.myMateList = new MateList_1.default(true, false), (0, skynode_1.el)("a.submit-button", "메이트 등록", {
            click: async () => {
                await MatesListenersContract_1.default.listen(turntableId, this.myMateList.selectedMateIds);
