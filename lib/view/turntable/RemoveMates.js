...
class RemoveMates {
    constructor(params) {
        ...
        }), (0, skynode_1.el)("p", "해당 턴테이블에서 더 이상 리스너로 등록되지 않을 메이트를 선택해주시기 바랍니다."), this.myMateList = new MateList_1.default(true, false), (0, skynode_1.el)("a.submit-button", "메이트 등록 취소", {
            click: async () => {
                await MatesListenersContract_1.default.unlisten(turntableId, this.myMateList.selectedMateIds);
