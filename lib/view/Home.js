...
class Home {
    ...
    async loadWinner() {
        this.winner.appendText(`${(0, msg_js_1.default)("HOME_WINNER_TITLE").replace(/{round}/, String(1))} `);
        this.winner.append((0, skynode_1.el)("a", "0x7c8E0D8E520e2BF9647572a1998afa7D1631f16e"));
    }
    async loadDogeSound() {
        this.dogesound.appendText(`${(0, msg_js_1.default)("HOME_WINNER_DESCRIPTION").replace(/{round}/, String(1))} \nㅡ`);
    }
