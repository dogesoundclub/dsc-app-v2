...
class Home {
    ...
    async loadDogeSound() {
        ...
        try {
            const round = (await DogeSoundContestContract_1.default.getRound()).toNumber() - 1;
            const elected = (await DogeSoundContestContract_1.default.getElected(round)).toNumber();
            const dogesound = await DogeSoundContestContract_1.default.getCandidate(round, elected);
            const winner = await DogeSoundContestContract_1.default.getCandidateRegister(round, elected);
