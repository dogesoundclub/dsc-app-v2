...
class DogeSounds {
    ...
    async load() {
        ...
        if (period === DogeSoundContestV2Contract_1.default.HOLIDAY_PERIOD) {
            ...
            this.form = (0, skynode_1.el)("a.nft-mint-button", (0, msg_js_1.default)("DOGESOUNDS_WINNER_NFT_MINT_BUTTON"), {});
        }
