            ...
            click: () => {
                if (termCheckbox.domElement.checked === true) {
                    new Confirm_1.default((0, msg_js_1.default)("GOVERNANCE_PROPOSE_SUBMIT_CONFIRM"), (0, msg_js_1.default)("CONFIRM_BUTTON"), async () => {
                        ...
                        if (owner !== undefined) {
                            const minProposePeriod = (await VoteContract_1.default.getMinProposePeriod()).toNumber();
                            const maxProposePeriod = (await VoteContract_1.default.getMaxProposePeriod()).toNumber();
