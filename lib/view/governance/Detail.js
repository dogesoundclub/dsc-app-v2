...
class Detail {
    constructor(params) {
        ...
        })), this.mateList = new MateList_1.default(true, false), (0, skynode_1.el)(".select", (0, skynode_1.el)("label.for", (0, skynode_1.el)("span.title", "For"), forRadio = (0, skynode_1.el)("input", {
            name: "governance-radio",
            type: "radio",
        })), (0, skynode_1.el)("label.against", (0, skynode_1.el)("span.title", "Against"), againstRadio = (0, skynode_1.el)("input", {
            name: "governance-radio",
            type: "radio",
    ...
    async load(id) {
        ...
        voteCounts.append((0, skynode_1.el)(".for-votes", (0, skynode_1.el)("span.title", "For"), (0, skynode_1.el)("span.count", String(await VoteContract_1.default.getForVotes(id)))));
        voteCounts.append((0, skynode_1.el)(".against-votes", (0, skynode_1.el)("span.title", "Against"), (0, skynode_1.el)("span.count", String(await VoteContract_1.default.getAgainstVotes(id)))));
        let content;
