...
class Layout {
    constructor() {
        ...
        }), new PCMenu_1.default()), (0, skynode_1.el)("main", this.content = (0, skynode_1.el)(".content")), (0, skynode_1.el)("footer", (0, skynode_1.el)("span", "© 2021 DSLAB"), (0, skynode_1.el)("a", "TERMS & CONDITIONS", { click: () => skyrouter_1.SkyRouter.go("/terms") }))));
    }
    set title(title) {
