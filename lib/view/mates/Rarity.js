...
class Rarity {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".gallary-view", (0, skynode_1.el)(".filter", (0, skynode_1.el)("h2", (0, msg_js_1.default)("RARITY_TITLE")), (0, skynode_1.el)("input", {
        ...
        }), (0, skynode_1.el)("a.reset-button", (0, msg_js_1.default)("GALLARY_RESET_FILTER_BUTTON"), {
            click: () => {
                this.filter = {};
                this.byId = undefined;
                this.loadMates();
