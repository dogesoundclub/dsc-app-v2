...
class MyMates {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".mymates-view", (0, skynode_1.el)("h1", (0, msg_js_1.default)("MY_MATES_TITLE")), this.wallet = (0, skynode_1.el)(".wallet"), this.loading = new Loading_1.default(), this.mateList = new MateList_1.default()));
        this.windowResizeHandler();
        this.load();
