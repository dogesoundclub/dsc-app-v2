...
class Gallery {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)(".gallery-view", (0, skynode_1.el)(".filter", (0, skynode_1.el)("h2", (0, msg_js_1.default)("GALLERY_TITLE")), (0, skynode_1.el)("input", {
        ...
        }, (0, skynode_1.el)("option", key, { value: "" }), key === "Face" ? undefined : (0, skynode_1.el)("option", "None", { value: "None" }), ...values.map((value) => (0, skynode_1.el)("option", value, { value })))), (0, skynode_1.el)("a.reset-button", (0, msg_js_1.default)("GALLERY_RESET_FILTER_BUTTON"), {
            click: () => {
                this.filter = {};
                this.byId = undefined;
                this.loadMates();
